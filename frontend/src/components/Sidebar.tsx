...
const navItems: NavItem[] = [
  ...
  { to: '/service-orders', label: 'Órdenes de Servicio', icon: 'orders' },
  { to: '/parts', label: 'Piezas', icon: 'parts' },
    ...
    <aside className="w-64 bg-surface-800 border-r border-surface-600 flex flex-col h-full fixed left-0 top-0 bottom-0">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-surface-600">
        <div className="h-9 w-9 rounded-lg bg-amber-500 flex items-center justify-center flex-shrink-0">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-surface-900">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 ${
                isActive
                  ? 'bg-amber-500/15 text-amber-400 border-l-2 border-amber-500 pl-[10px]'
                  : 'text-gray-400 hover:bg-surface-700 hover:text-gray-100 border-l-2 border-transparent pl-[10px]'
              }`
            }
          >
      ...
      <div className="border-t border-surface-600 p-3">
        <div className="flex items-center gap-3 px-2 py-2 rounded-lg mb-1">
          <div className="h-8 w-8 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center text-surface-900 font-bold text-xs flex-shrink-0 ring-2 ring-amber-500/30">
            {initials}
          </div>
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-2 px-3 py-2 text-gray-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg text-xs font-medium transition-all duration-150"
        >
          {icons.logout}
          Cerrar sesión
        </button>
